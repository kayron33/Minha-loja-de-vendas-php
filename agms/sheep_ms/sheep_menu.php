          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?=FILTROS?>empresa/index">Configurações</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="trending-up"></i><span>Usuarios</span></a>
              <ul class="dropdown-menu">
                 <li><a href="<?=FILTROS?>usuarios/index">Listar</a></li>
             </ul>
            </li>
